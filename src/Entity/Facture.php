...
class Facture
{
    ...
    #[ORM\OneToMany(mappedBy: 'facture', targetEntity: CommandLine::class, orphanRemoval: true, cascade: ["persist"], fetch: 'EAGER')]
    ...
    public function removeCommandLine(CommandLine $commandLine): self
    {
        if ($this->commandLines->removeElement($commandLine)) {
            ...
            if ($commandLine->getFacture() === $this) {
                $commandLine->setFacture(null);
            }
        }
